			...
			<div className="container mx-auto px-4">
				...
				>
					<motion.h2
						...
						className="text-4xl md:text-5xl font-poppins  gradient-text font-bold text-edu mb-6"
					>
						Admission Enquiry
					</motion.h2>
					<motion.p
												...
												<div className="flex items-start space-x-3">
													...
													<div>
														...
														<p className="text-gray-600 text-sm">
															Fill out the form with child's details or Contact
															with Us
														</p>
													</div>
												</div>
